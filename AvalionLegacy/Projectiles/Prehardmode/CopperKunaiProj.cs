...
{
	public class CopperKunaiProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			if (!isStickingToTarget)
			{
				...
				{
					Dust dust = Dust.NewDustDirect(projectile.position, projectile.height, projectile.width, mod.DustType<Dusts.Booty>(),
